 ...
 * @author zk
 * @version 1.0
 * @since 2021-07-19 23:01
 */
@Component
public class GovDownLoader implements Downloader {
    ...
    protected void onError(Request request) {
        try (FileWriter fileWriter = new FileWriter("C:\\Users\\Administrator\\Desktop\\11.txt")) {
            fileWriter.append("/n").append(request.getUrl());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
